...
```
2.Установите зависимости c помощью виртуального окружение Poetry:
```
poetry install
```
## Принципы работы:
...
1.Функция проходит по всем элементам списка

2.Проверяет значение ключа "state" в каждом словаре

3.Добавляет в результат только те элементы, где состояние совпадает с заданным

## Примеры использования:

1.Использует встроенную функцию sorted()

2.В качестве ключа сортировки использует значение ключа "date"

3.Направление сортировки контролируется параметром ascending
